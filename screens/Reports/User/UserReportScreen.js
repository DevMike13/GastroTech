                            ...
                            <View style={{ marginVertical: 10}}>
                                <Text style={styles.reportTitleText}>Gas Levels</Text>
                                {
                                    gasData.datasets && gasData.datasets.length > 0 ? (
                                            ...
                                            <LineChart
                                                data={gasData}
                                                width={gasData.labels.length > 5 ? gasData.datasets.length * 1000 : Dimensions.get('window').width}
                                                height={220}
                                                yAxisInterval={1}
                                ...
                                <Text style={styles.reportTitleText}>Temperature</Text>
                                {
                                    temperatureData.datasets && temperatureData.datasets.length > 0 ? (
                                            ...
                                            <LineChart
                                                ...
                                                width={temperatureData.labels.length > 5 ? temperatureData.datasets.length * 1000 : Dimensions.get('window').width}
                                                height={250}
                                                yAxisInterval={1} 
                                                verticalLabelRotation={10}
                                                chartConfig={{
